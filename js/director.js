...
export let Director = {
    ...
    cut : async (currentScene,nextScene,params) => {
        Director.app.stage.removeChild(currentScene);
        Director.app.stage.addChild(nextScene);
    },
    ...
    swipe : async (currentScene,nextScene,params) => {
        ...
        if (params.direction == "left") {
            currentSceneEndX = -Director.app.view.width;
            currentSceneEndY = 0;
            nextSceneStartX = Director.app.view.width;
            nextSceneStartY = 0;
        }
            ...
            currentSceneEndX = 0;
            currentSceneEndY = -Director.app.view.height;
            nextSceneStartX = 0;
            nextSceneStartY = Director.app.view.height;
        }
